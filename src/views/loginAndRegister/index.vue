<template>
  <div class="container" :class="{ 'sign-up-mode': controlPage.signUpMode }">
    <!-- form表单容器 -->
    <div class="forms-container">
      <div class="signin-signup">
        <!-- 登录 -->
        <loginForm v-if='!controlPage.signUpMode'  />
        <!-- 注册 -->
        <registerForm @changeLogin='controlPage.change' v-else   />
      </div>
    </div>
    <!-- 左右切换动画 -->
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <p>何以解忧，唯有杜康</p>
          <button @click="controlPage.change" class="btn transparent">注册</button>
        </div>
        <img src="@/assets/loginAndRegister/login.svg" class="image" alt="" />
      </div>
